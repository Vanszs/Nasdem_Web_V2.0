...
import { ArrowUp, Target, Users, BookOpen, Heart, Globe, Table, CheckCircle } from "lucide-react"
  ...
  const visiPoints = [
    {
      ...
      title: "Merdeka",
      description: "Freedom dan Liberty - Indonesia yang benar-benar merdeka dari segala bentuk penjajahan, baik fisik maupun mental"
    },
    {
      icon: <Target className="w-6 h-6 text-secondary" />,
      title: "Kedaulatan Ekonomi",
      description: "Berdaulat secara ekonomi dengan memberantas kemiskinan dan kesenjangan untuk mencapai keadilan sosial"
    },
    {
      icon: <Heart className="w-6 h-6 text-secondary" />,
      title: "Martabat Budaya",
      description: "Bermartabat dalam budaya dengan melestarikan dan mengembangkan kekayaan budaya Indonesia"
    }
  ]
  ...
  const misiPoints = [
    {
      ...
      description: "Membangun sistem politik yang demokratis dan berkeadilan, bebas dari oligarki, politik uang, dan KKN"
    },
    {
      icon: <Globe className="w-6 h-6 text-secondary" />,
      title: "Sistem Ekonomi Demokratis",
      description: "Menegakkan sistem ekonomi yang demokratis untuk kesejahteraan seluruh rakyat Indonesia"
    },
    {
      icon: <BookOpen className="w-6 h-6 text-secondary" />,
      title: "Gotong Royong",
      description: "Menghidupkan kembali budaya gotong royong sebagai fondasi kehidupan bermasyarakat"
    }
  ]
  ...
  const missionTableData = [
    {
      ...
      masalah: ["Oligarki", "Politik Uang", "KKN", "Distrust Publik terhadap Partai"],
      aksiDPP: [
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Landasan filosofis dan arah pergerakan Partai NasDem dalam membangun Indonesia yang merdeka, 
              berdaulat secara ekonomi, dan bermartabat dalam budaya.
            </p>
          </motion.div>
        </div>
      </section>
                ...
                <Card className="border-2 border-secondary/20 bg-gradient-to-br from-secondary/5 to-primary/5">
                  <CardHeader className="text-center pb-6">
                    ...
                    <blockquote className="text-xl md:text-2xl font-semibold text-foreground leading-relaxed italic">
                      "Indonesia yang merdeka sebagai negara bangsa, berdaulat secara ekonomi, 
                      dan bermartabat dalam budaya."
                    </blockquote>
                  </CardHeader>
                </Card>
                  ...
                  <CardContent className="prose prose-lg max-w-none">
                    <div className="space-y-6 text-muted-foreground leading-relaxed">
                      <div className="bg-secondary/5 p-6 rounded-lg border-l-4 border-l-secondary">
                        <h4 className="text-lg font-semibold text-primary mb-3">Pengertian Visi dan Misi</h4>
                        <p>
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-primary mb-3">Landasan Hukum dan Hierarki</h4>
                        <p>
                      ...
                      <div className="bg-primary/5 p-6 rounded-lg">
                        <h4 className="text-lg font-semibold text-primary mb-3">Pentingnya Visi dan Misi</h4>
                        <p>
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-primary mb-3">Tiga Kata Kunci Visi</h4>
                        <p className="mb-4">
                        ...
                        <div className="space-y-4">
                          <div className="border-l-4 border-l-secondary pl-4">
                            <h5 className="font-semibold text-primary mb-2">1. Merdeka</h5>
                            <p>
                          ...
                          <div className="border-l-4 border-l-secondary pl-4">
                            <h5 className="font-semibold text-primary mb-2">2. Kedaulatan Ekonomi</h5>
                            <p>
                          ...
                          <div className="border-l-4 border-l-secondary pl-4">
                            <h5 className="font-semibold text-primary mb-2">3. Martabat Kebudayaan</h5>
                            <p>
                      ...
                      <div className="bg-secondary/5 p-6 rounded-lg border-l-4 border-l-secondary">
                        <h4 className="text-lg font-semibold text-primary mb-3">Komitmen Realisasi</h4>
                        <p>
              ...
              >
                ...
                <Card className="border-2 border-secondary/20 bg-gradient-to-br from-secondary/5 to-primary/5">
                  <CardHeader className="text-center pb-6">
                    ...
                    <div className="w-20 h-1 bg-secondary mx-auto mb-6" />
                    <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                      Langkah-langkah konkret untuk mewujudkan visi Indonesia yang merdeka, berdaulat, dan bermartabat
                    </p>
                  </CardHeader>
                </Card>
                ...
                <Card className="bg-muted/50 border-primary/20">
                  ...
                  <CardContent>
                    <div className="space-y-6 text-muted-foreground leading-relaxed">
                      ...
                      <p>
                        Supaya mempermudah kader untuk melakukan 'aksi' berdasarkan lima isu dalam 'misi' itu, buku Pedoman Dasar Kader ini memberikan contoh lembar kerja dalam tabel berikut:
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-white border-primary/20">
                  <CardHeader>
                    ...
                    <p className="text-muted-foreground mt-2">
                      Contoh lembar kerja untuk implementasi misi sistem politik yang demokratis dan berkeadilan
                    </p>
                  </CardHeader>
                  <CardContent>
                            ...
                            <tr key={index} className="hover:bg-muted/30 transition-colors">
                              ...
                              <td className="border border-primary/20 px-4 py-4 align-top">
                                <div className="space-y-2">
                                  <p className="text-sm text-muted-foreground font-medium">{row.aksiDPP[0]}</p>
                                  <ul className="space-y-1">
                    ...
                    <div className="space-y-6 text-muted-foreground leading-relaxed">
                      ...
                      <div className="grid md:grid-cols-3 gap-6">
                        <div className="bg-white p-6 rounded-lg border border-primary/10">
                          ...
                          <p className="text-sm">
                            Prinsipnya, apa yang dilakukan DPP adalah untuk dan dalam konteks <strong>kedikenal</strong>an—supaya partai dikenal di tingkat nasional.
                          </p>
                        </div>
                        <div className="bg-white p-6 rounded-lg border border-primary/10">
                          <h4 className="font-semibold text-primary mb-3 flex items-center gap-2">
                          ...
                          <p className="text-sm">
                            Apa yang dilakukan DPW dan DPD adalah untuk <strong>kedisuka</strong>an partai di tingkat wilayah dan daerah.
                          </p>
                        </div>
                        <div className="bg-white p-6 rounded-lg border border-primary/10">
                          <h4 className="font-semibold text-primary mb-3 flex items-center gap-2">
                          ...
                          <p className="text-sm">
                            Dan, apa yang dilakukan DPC/DPRt adalah untuk <strong>kedipili</strong>han, karena basis suara sebenarnya berada di tingkat DPC/DPRt.
                          </p>
                        </div>
                      </div>

                      <div className="bg-secondary/5 p-6 rounded-lg border-l-4 border-l-secondary">
                        <h4 className="text-lg font-semibold text-primary mb-3">Fokus Masalah yang Diatasi:</h4>
                        <ul className="grid md:grid-cols-2 gap-3">
                          ...
                          <li className="flex items-center gap-2">
                            <div className="w-2 h-2 bg-secondary rounded-full" />
                            <span>Ketidakpercayaan publik terhadap partai politik</span>
                          </li>
                        </ul>
                      </div>
                    </div>
