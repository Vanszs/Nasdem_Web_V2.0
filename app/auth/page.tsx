  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-[#001B55] via-[#002266] to-[#001B55]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute bottom-20 right-20 w-96 h-96 bg-[#FF9C04]/5 rounded-full blur-3xl animate-pulse"
        ...
        <div
          className="absolute top-1/3 right-1/3 w-1.5 h-1.5 bg-white/50 rounded-full animate-float"
          style={{ animationDelay: "0.5s" }}
        ></div>
        <div
          className="absolute bottom-1/4 left-1/2 w-2.5 h-2.5 bg-[#FF9C04]/60 rounded-full animate-float"
        ...
        <div className="grid lg:grid-cols-2 gap-0 bg-white/95 backdrop-blur-xl">
            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-white/70 text-lg leading-relaxed">
                  Secure access to manage content, members, and analytics for
          ...
          <div className="flex flex-col justify-center p-8 lg:p-12">
            ...
            <div className="lg:hidden flex items-center gap-3 mb-8">
              ...
              <div>
                <h1 className="text-xl font-bold text-[#001B55]">
                  NasDem Sidoarjo
                </h1>
            ...
            <div className="space-y-6">
                    ...
                    <Input
                      ...
                      className={cn(
                        ...
                        form.formState.errors.email &&
                          "border-[#C81E1E] focus:border-[#C81E1E] focus:ring-[#C81E1E]/10"
                      )}
                    />
                  </div>
                  {form.formState.errors.email && (
              ...
              <div className="pt-6 border-t border-gray-200">
                <p className="text-center text-sm text-gray-500">
                  Protected by enterprise-grade security • © 2025 DPD NasDem
                  Sidoarjo
                </p>
              </div>
            </div>
