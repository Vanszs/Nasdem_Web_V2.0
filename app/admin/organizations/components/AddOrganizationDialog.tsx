...
const initialForm = {
  level: "dpd", // Give a default value to avoid empty state
  position: "ketua", // Give a default value to avoid empty state
  regionId: undefined as number | undefined,
  sayapTypeId: undefined as number | undefined,
  startDate: "",
  endDate: "",
};
...
export function AddOrganizationDialog({
  ...
  React.useEffect(() => {
    if (!open) {
      // Only reset the form when dialog closes
      setForm(initialForm);
    }
  }, [open]);
  ...
  // Add debugging
  React.useEffect(() => {
    console.log("AddDialog open state:", open);
  }, [open]);
  ...
  const submit = (e: React.FormEvent) => {
    ...
    onCreate({
      ...
      sayapTypeId: form.sayapTypeId || undefined,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl bg-white/95 backdrop-blur-xl border-0 shadow-2xl">
        <div className="absolute inset-0 pointer-events-none bg-gradient-to-br from-[#001B55]/5 via-transparent to-[#FF9C04]/5 rounded-2xl" />

        <div className="relative">
          <DialogHeader className="text-center pb-8">
            <div className="mx-auto w-16 h-16 bg-gradient-to-br from-[#001B55] to-[#001B55]/80 rounded-2xl flex items-center justify-center mb-4 shadow-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {showRegion && (
                    <div className="space-y-3">
                      ...
                      <Select
                        value={form.regionId ? String(form.regionId) : "none"}
                        onValueChange={(v) =>
                          setForm((s) => ({
                            ...s,
                            regionId: v === "none" ? undefined : Number(v),
                          }))
                        }
                      >
                        <SelectTrigger className="h-12 bg-white/80 border-[#001B55]/10 rounded-xl hover:border-[#001B55]/20 focus:border-[#001B55] transition-all duration-200 shadow-sm">
                  ...
                  {showSayap && (
                    <div className="space-y-3">
                      ...
                      <Select
                        value={
                          form.sayapTypeId ? String(form.sayapTypeId) : "none"
                        }
                        onValueChange={(v) =>
                          setForm((s) => ({
                            ...s,
            ...
            <DialogFooter className="pt-8 border-t border-[#001B55]/10">
              <div className="flex gap-4 w-full">
                ...
                <Button
                  type="submit"
                  disabled={creating}
                  className="flex-1 h-12 bg-gradient-to-r from-[#001B55] to-[#001B55]/90 hover:from-[#001B55]/90 hover:to-[#001B55] text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-200"
                >
                  {creating ? (
