...
export default function NewsPreviewPage() {
  ...
  const formatDate = (dateString?: string) => {
    ...
    try {
      return format(new Date(dateString), "d MMMM yyyy 'pukul' HH:mm", { locale: id });
    } catch (error) {
      return dateString;
    }
  };
      ...
      <AdminLayout breadcrumbs={[]}>
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#FF9C04] mx-auto mb-4"></div>
          ...
          <Card className="max-w-md w-full">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-muted-foreground mb-4">
                Tidak ada data pratinjau yang tersedia. Silakan buat berita terlebih dahulu.
              </p>
      ...
      <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  Tampilan berita seperti yang akan terlihat oleh pengunjung website
                </p>
              </div>
            </div>
          </div>
        ...
        <Card className="border-2 border-gray-200 shadow-lg overflow-hidden">
          ...
          <CardContent className="p-8">
            ...
            {/* Preview Notice */}
            <div className="mt-8 p-4 bg-[#FF9C04]/10 border border-[#FF9C04]/20 rounded-lg">
              <p className="text-sm text-[#001B55]">
                <strong>Perhatian:</strong> Ini adalah halaman pratinjau. Berita belum dipublikasikan dan hanya visible untuk Anda.
              </p>
            </div>
          </CardContent>
        </Card>
