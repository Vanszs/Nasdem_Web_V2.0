      ...
      <div className="flex h-16 items-center justify-between px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent
              align="end"
              className="w-80 p-0 bg-white/95 backdrop-blur-xl border-gray-200/50 shadow-xl rounded-2xl overflow-hidden"
            >
              ...
              <div className="max-h-80 overflow-y-auto">
                <DropdownMenuItem className="px-4 py-3 flex items-start gap-3 hover:bg-gray-50/70 cursor-pointer transition-colors duration-200">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-foreground">
                      Berita baru dipublish
                    </p>
                    <p className="text-xs text-muted-foreground mt-1">
                      "Program Infrastruktur Sidoarjo 2024" telah berhasil
                      dipublish dan siap tayang
                    </p>
                    <p className="text-xs text-muted-foreground mt-1">
                      2 menit yang lalu
                    </p>
                ...
                <DropdownMenuItem className="px-4 py-3 flex items-start gap-3 hover:bg-gray-50/70 cursor-pointer transition-colors duration-200">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-foreground">
                      Struktur organisasi diperbarui
                    </p>
                    <p className="text-xs text-muted-foreground mt-1">
                      Data pengurus DPC Waru telah diperbarui dengan informasi
                      terbaru
                    </p>
                    <p className="text-xs text-muted-foreground mt-1">
                      3 jam yang lalu
              ...
              <div className="px-4 py-3 border-t border-gray-100 bg-gray-50/50">
                <Button
                  variant="ghost"
                  className="w-full text-primary hover:bg-primary/5 hover:text-primary rounded-xl transition-all duration-300"
                >
