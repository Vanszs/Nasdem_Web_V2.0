...
export function KPICard({
  ...
  const colorClasses = {
    primary:
      "text-[#001B55] bg-gradient-to-br from-[#001B55]/10 to-[#001B55]/5",
    accent: "text-[#FF9C04] bg-gradient-to-br from-[#FF9C04]/10 to-[#FF9C04]/5",
    success:
      "text-[#16A34A] bg-gradient-to-br from-[#16A34A]/10 to-[#16A34A]/5",
    warning:
      "text-[#F59E0B] bg-gradient-to-br from-[#F59E0B]/10 to-[#F59E0B]/5",
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 bg-gradient-to-br ${gradientClasses[color]} opacity-20 group-hover:opacity-30 transition-opacity duration-300`}
      />
      ...
      <CardHeader className="relative flex flex-row items-center justify-between space-y-0 pb-1 p-4">
        ...
        <div
          className={`p-2 rounded-xl border border-current/20 transition-all duration-300 group-hover:scale-105 ${colorClasses[color]}`}
        >
          ...
          <div className="flex-1">
            ...
            <div className="mt-2 h-0.5 bg-[#F0F0F0] rounded-full overflow-hidden">
              <div
                ...
                } rounded-full w-0 group-hover:w-full transition-all duration-500 ease-out`}
              />
            </div>
          </div>
