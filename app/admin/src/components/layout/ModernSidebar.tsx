...
export function ModernSidebar({ isCollapsed = false, onToggle }: ModernSidebarProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative p-6 border-b border-white/10">
        <div className="relative flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="relative w-12 h-12 rounded-smooth flex items-center justify-center shadow-2xl"
                 style={{
                   background: 'linear-gradient(135deg, hsl(33, 100%, 51%) 0%, hsl(38, 95%, 55%) 100%)',
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden px-4 pb-4 pt-1 space-y-2 min-h-0 scrollbar-hide"
           style={{ 
             scrollbarWidth: 'none',
