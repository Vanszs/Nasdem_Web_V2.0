...
export function MemberListPage() {
  ...
  const departmentConfig = {
    ...
    Sayap: { 
      label: "Sayap", 
      className: "bg-[#FF9C04] hover:bg-[#001B55] text-white text-white border-2 border-[#FF9C04]"
    },
    DPC: { 
      label: "DPC", 
          ...
          <div className="flex items-center justify-between">
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              <DialogTrigger asChild>
                <Button className="bg-[#FF9C04] hover:bg-[#001B55] text-white border-2 border-[#FF9C04] hover:border-[#001B55] transition-all duration-300">
              ...
              <DialogContent className="max-w-2xl border-2 border-gray-300/80">
                    ...
                    <div className="mt-2 flex flex-col items-center">
                      <div className="relative mb-4">
                        ...
                        <label
                          ...
                          className="absolute bottom-0 right-0 bg-[#FF9C04] hover:bg-[#001B55] text-white text-white rounded-full p-1.5 cursor-pointer hover:bg-[#FF9C04] hover:bg-[#001B55] text-white/90 transition-colors"
                        >
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <Button onClick={handleAddMember} className="bg-[#FF9C04] hover:bg-[#001B55] text-white border-2 border-[#FF9C04] hover:border-[#001B55]">
                    <Plus className="mr-2 h-4 w-4" />
                    Tambah Anggota
                  </Button>
                </div>
        ...
        {paginatedMembers.length > 0 ? (
          ...
          <Card className="border-2 border-gray-300/80 shadow-lg">
            <CardContent className="p-12 text-center">
              ...
              <Button onClick={() => setIsAddDialogOpen(true)} className="bg-[#FF9C04] hover:bg-[#001B55] text-white border-2 border-[#FF9C04] hover:border-[#001B55]">
                <Plus className="mr-2 h-4 w-4" />
                Tambah Anggota
              </Button>
            </CardContent>
