...
import heroImage from "@/public/dashboard-hero.jpg";
    ...
    <AdminLayout breadcrumbs={breadcrumbs}>
      <div className="min-h-screen bg-gradient-to-br from-gray-50/50 via-white to-blue-50/30">
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-gradient-to-br from-primary via-primary/90 to-accent text-white shadow-2xl border border-white/20 backdrop-blur-sm">
            ...
            {/* Floating Elements */}
            <div className="absolute top-4 right-4 md:top-8 md:right-8 w-24 h-24 md:w-32 md:h-32 bg-gradient-to-br from-white/10 to-accent/10 rounded-full blur-2xl animate-pulse" />
            <div className="absolute bottom-4 left-4 md:bottom-8 md:left-8 w-16 h-16 md:w-24 md:h-24 bg-gradient-to-br from-accent/10 to-white/10 rounded-full blur-xl animate-pulse delay-1000" />
            ...
            <div className="relative p-6 md:p-10 lg:p-12">
              <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                ...
                <Badge className="bg-white/10 border-white/20 text-white hover:bg-white/20 backdrop-blur-sm text-xs md:text-sm">
                  v2.0 Modern
                </Badge>
              </div>
              
              <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-2 md:mb-3 bg-gradient-to-r from-white via-white to-white/80 bg-clip-text">
                Selamat Datang di Admin Panel
              </h1>
              <p className="text-white/90 text-lg md:text-xl mb-1 md:mb-2 font-medium">
              ...
              {/* Quick Stats */}
              <div className="mt-6 md:mt-8 flex flex-wrap items-center gap-3 md:gap-6 text-xs md:text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/80 hidden sm:inline">Auto Backup Active</span>
                  <span className="text-white/80 sm:hidden">Backup Active</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <section className="bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl border-2 border-gray-300/80 p-4 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300">
            <div className="mb-6 md:mb-8">
              <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-3">
                <div className="w-2 md:w-3 h-8 md:h-10 bg-gradient-to-b from-primary to-accent rounded-full shadow-md"></div>
                <h2 className="text-xl md:text-3xl font-bold text-foreground">Overview Statistik</h2>
              </div>
              <p className="text-muted-foreground text-sm md:text-lg">Ringkasan performa dan aktivitas sistem real-time</p>
            </div>
